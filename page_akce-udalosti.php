...
<div class="container">
    <div class="page-body col-12 col-lg-8">
      <h6 class="sekce-nadpis">Osice > Volný čas > Akce a události</h6>
      <div class="uredni-deska">
        <h3 class="informace-nadpis">Akce a události</h3>

        <div class="display-flex-row" style="justify-content: space-around;">
          <button class="udalosti-button udalosti-button-active">2021</button>
          <button class="udalosti-button">2020</button>
          <button class="udalosti-button">2019</button>
          <button class="udalosti-button">2018</button>
