<footer>
    ...
    <div class="container paticka-vrchni">
    ...
    <div class="paticka-stred">
        <div class="container display-flex-row">
            ...
            <h3 class="paticka-nadpis">Tísňové volání</h3>
                <a class="paticka-text paticka-odkaz">158 - Policie ČR</a>
                <a class="paticka-text paticka-odkaz">150 - Hasičský záchranný sbor ČR</a>
                <a class="paticka-text paticka-odkaz">155 - Zdravotnická zíchranná služba</a>
                <a class="paticka-text paticka-odkaz">112 - Jednotné evropské č. tísňového volání</a><br>
                <a class="paticka-text paticka-odkaz">+420 777 123 456 - Poruchy vodovodu</a>
                <a class="paticka-text paticka-odkaz">+420 777 456 789 - Poruchy elektriky</a>
                <a class="paticka-text paticka-odkaz">1239 - Pohotovost plyn</a>
            </div>

            <div class="display-flex-column col-12 col-lg-3 paticka-stred-column">
                <h3 class="paticka-nadpis">Často hledané</h3>
                <a class="paticka-odkaz paticka-text" href="">Česká pošta</a>
                <a class="paticka-odkaz paticka-text" href="">Základní škola</a>
                <a class="paticka-odkaz paticka-text" href="">Mateřská škola</a>
                <a class="paticka-odkaz paticka-text" href="">Knihovna</a>
            </div>
        </div>
    </div>
    ...
    <div class="paticka-spodni">
        <div class="container display-flex-row">
            <p class="paticka-text paticka-margin col-12 col-lg-6">© 2021 Obec Osice - Oficiální webové stránky</p>
            <div class="display-flex-row paticka-spodni-odkazy col-12 col-lg-6">
                <a class="paticka-odkaz paticka-text" href="">Ke stažení</a>
                <div class="paticka-tecka"></div>
                <a class="paticka-odkaz paticka-text" href="">O webu</a>
                <div class="paticka-tecka"></div>
                <a class="paticka-odkaz paticka-text" href="">Prohlášení o přístupnosti</a>
                <div class="paticka-tecka"></div>
                <a class="paticka-odkaz paticka-text" href="">Mapa stránek</a>
            </div>
        </div>    
    </div>
